...
namespace FinalBeansStats {
    ...
    public class LevelStats {
        public static Dictionary<string, LevelStats> ALL = new Dictionary<string, LevelStats>(StringComparer.OrdinalIgnoreCase) {
            ...
            { "round_skeefall",                                   new LevelStats("round_skeefall", "Ski Fall", LevelType.Race, BestRecordType.Fastest, false, 1, Properties.Resources.round_ski_fall_icon, Properties.Resources.round_ski_fall_big_icon)},
            ...
            { "round_fall_mountain",                              new LevelStats("round_fall_mountain", "Fall Mountain", LevelType.Race, BestRecordType.Fastest, true, 1, Properties.Resources.round_fall_mountain_icon, Properties.Resources.round_fall_mountain_big_icon)},
