...
namespace FinalBeansStats {
    sealed partial class Overlay {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblFilter = new FinalBeansStats.TransparentLabel();
            this.lblProfile = new FinalBeansStats.TransparentLabel();
            this.lblStreak = new FinalBeansStats.TransparentLabel();
            this.lblFinals = new FinalBeansStats.TransparentLabel();
            this.lblQualifyChance = new FinalBeansStats.TransparentLabel();
            this.lblFastest = new FinalBeansStats.TransparentLabel();
            this.lblDuration = new FinalBeansStats.TransparentLabel();
            this.lblPingIcon = new FinalBeansStats.TransparentLabel();
            this.lblCountryIcon = new FinalBeansStats.TransparentLabel();
            this.lblPlayers = new FinalBeansStats.TransparentLabel();
            this.lblPlayersPc = new FinalBeansStats.TransparentLabel();
            this.lblPlayersMobile = new FinalBeansStats.TransparentLabel();
            this.lblPlayersPs = new FinalBeansStats.TransparentLabel();
            this.lblPlayersXbox = new FinalBeansStats.TransparentLabel();
            this.lblPlayersSwitch = new FinalBeansStats.TransparentLabel();
            this.lblRound = new FinalBeansStats.TransparentLabel();
            this.lblWins = new FinalBeansStats.TransparentLabel();
            this.lblFinish = new FinalBeansStats.TransparentLabel();
            ...
            // lblPingIcon
            // 
            this.lblPingIcon.ImageHeight = 12;
            this.lblPingIcon.ImageWidth = 15;
            this.lblPingIcon.ImageX = 0;
            this.lblPingIcon.ImageY = 1;
            ...
            this.LocationChanged += new System.EventHandler(this.Overlay_LocationChanged);
        ...
        private FinalBeansStats.TransparentLabel lblRound;
        private FinalBeansStats.TransparentLabel lblDuration;
        private FinalBeansStats.TransparentLabel lblFinish;
        private FinalBeansStats.TransparentLabel lblFastest;
        private FinalBeansStats.TransparentLabel lblQualifyChance;
        private FinalBeansStats.TransparentLabel lblWins;
        private FinalBeansStats.TransparentLabel lblFinals;
        private FinalBeansStats.TransparentLabel lblPlayers;
        private FinalBeansStats.TransparentLabel lblPingIcon;
        private FinalBeansStats.TransparentLabel lblCountryIcon;

        private FinalBeansStats.TransparentLabel lblPlayersPc;
        private FinalBeansStats.TransparentLabel lblPlayersMobile;
        private FinalBeansStats.TransparentLabel lblPlayersPs;
        private FinalBeansStats.TransparentLabel lblPlayersXbox;
        private FinalBeansStats.TransparentLabel lblPlayersSwitch;
        
        private FinalBeansStats.TransparentLabel lblStreak;
        private FinalBeansStats.TransparentLabel lblFilter;
        private FinalBeansStats.TransparentLabel lblProfile;
